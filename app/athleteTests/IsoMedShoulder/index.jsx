...
class IsoMedShoulderTest extends Component {
  state = {
...
IsoMedShoulderTest.defaultProps = {
  results: {}
};

IsoMedShoulderTest.displayName = 'IsoMedShoulderTest';

// IsoMedShoulderTest.whyDidYouRender = true;
