...
class IsoMedKneeTest extends Component {
  state = {
...
IsoMedKneeTest.defaultProps = {
  results: {}
};

IsoMedKneeTest.displayName = 'IsoMedKneeTest';

// IsoMedKneeTest.whyDidYouRender = true;
