...
export const getByDateRangeLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: EXPLOSIVE_JUMP_BY_DATE_RANGE_LOAD_SUCCESS,
    failType: EXPLOSIVE_JUMP_BY_DATE_RANGE_LOAD_ERROR
  },
...
export const getAllLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: EXPLOSIVE_JUMP_LOAD_SUCCESS,
    failType: EXPLOSIVE_JUMP_LOAD_ERROR
  },
  process({ getState, request }) {
