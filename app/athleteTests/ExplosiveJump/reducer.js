...
import {
  EXPLOSIVE_JUMP_BY_DATE_RANGE_LOAD_ERROR,
  EXPLOSIVE_JUMP_BY_DATE_RANGE_LOAD_SUCCESS,
  EXPLOSIVE_JUMP_LOAD_ERROR,
  EXPLOSIVE_JUMP_LOAD_SUCCESS,
  STATE_KEY
} from './constants';
...
export default explosiveJumpTestReducer;
