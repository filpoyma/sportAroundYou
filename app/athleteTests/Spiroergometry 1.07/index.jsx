...
import ColumnCell from '@/components/Table/elements/ColumnCell';
  ...
  render() {
    ...
    return (
      <TestResults status={statusSpiroergometry}>
        ...
        <Box title="Максимальные и пороговые показатели" className={className}>
...
export default compose(
  ...
  withLogic,
  withReducer
)(injectStyles(SpiroergometryTest, styles));
