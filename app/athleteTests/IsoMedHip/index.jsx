...
class IsoMedHipTest extends Component {
  state = {
...
IsoMedHipTest.defaultProps = {
  results: {}
};

IsoMedHipTest.displayName = 'IsoMedHipTest';

// IsoMedHipTest.whyDidYouRender = true;
