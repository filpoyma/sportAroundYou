...
export const getByDateRangeLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: FLEXIBILITY_SHOULDERS_BY_DATE_RANGE_LOAD_SUCCESS,
    failType: FLEXIBILITY_SHOULDERS_BY_DATE_RANGE_LOAD_ERROR
  },
...
export const getAllLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: FLEXIBILITY_SHOULDERS_LOAD_SUCCESS,
    failType: FLEXIBILITY_SHOULDERS_LOAD_ERROR
  },
  process({ getState, request }) {
