...
import { QUESTIONS } from '@/athleteTests/SportMotivationQuiz/constants';
...
class SportMotivationTest extends Component {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <>
        <Box title="Оценка мотивационной сферы" status={statusResultsByRange}>
          <HistogramChart {...histogramData} legendKey="Мотив" legendValue="Значение" units="ед" />
        </Box>
        ...
        <Box title="Ответы на вопросы" status={statusResultsByRange}>
          <QuizAnswers answers={rawData} multiQuestions questions={QUESTIONS} />
        </Box>
      </>
    );
  }
...
SportMotivationTest.defaultProps = {};

SportMotivationTest.displayName = 'SportMotivationTest';

// SportMotivationTest.whyDidYouRender = true;
