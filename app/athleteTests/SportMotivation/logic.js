...
export const getByDateRangeLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: SPORT_MOTIVATION_BY_DATE_RANGE_LOAD_SUCCESS,
    failType: SPORT_MOTIVATION_BY_DATE_RANGE_LOAD_ERROR
  },
...
export const getAllLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: SPORT_MOTIVATION_LOAD_SUCCESS,
    failType: SPORT_MOTIVATION_LOAD_ERROR
  },
  process({ getState, request }) {
