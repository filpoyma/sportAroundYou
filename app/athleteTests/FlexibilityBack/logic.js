...
export const getByDateRangeLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: FLEXIBILITY_BACK_BY_DATE_RANGE_LOAD_SUCCESS,
    failType: FLEXIBILITY_BACK_BY_DATE_RANGE_LOAD_ERROR
  },
...
export const getAllLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: FLEXIBILITY_BACK_LOAD_SUCCESS,
    failType: FLEXIBILITY_BACK_LOAD_ERROR
  },
  process({ getState, request }) {
