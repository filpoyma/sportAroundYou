...
import {
  FLEXIBILITY_BACK_BY_DATE_RANGE_LOAD_ERROR,
  FLEXIBILITY_BACK_BY_DATE_RANGE_LOAD_SUCCESS,
  FLEXIBILITY_BACK_LOAD_ERROR,
  FLEXIBILITY_BACK_LOAD_SUCCESS,
  STATE_KEY
} from './constants';
...
export default flexibilityBackTestReducer;
