...
export const getByDateRangeLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: COPING_STRATEGIES_BY_DATE_RANGE_LOAD_SUCCESS,
    failType: COPING_STRATEGIES_BY_DATE_RANGE_LOAD_ERROR
  },
...
export const getAllLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: COPING_STRATEGIES_LOAD_SUCCESS,
    failType: COPING_STRATEGIES_LOAD_ERROR
  },
  process({ getState, request }) {
