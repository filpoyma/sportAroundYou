...
import {
  API_PATH,
  SPORT_MOTIVATION_SCALE_BY_DATE_RANGE_LOAD_ERROR,
  SPORT_MOTIVATION_SCALE_BY_DATE_RANGE_LOAD_SUCCESS,
  SPORT_MOTIVATION_SCALE_LOAD_ERROR,
  SPORT_MOTIVATION_SCALE_LOAD_SUCCESS
} from './constants';
...
export const getByDateRangeLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: SPORT_MOTIVATION_SCALE_BY_DATE_RANGE_LOAD_SUCCESS,
    failType: SPORT_MOTIVATION_SCALE_BY_DATE_RANGE_LOAD_ERROR
  },
...
export const getAllLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: SPORT_MOTIVATION_SCALE_LOAD_SUCCESS,
    failType: SPORT_MOTIVATION_SCALE_LOAD_ERROR
  },
  process({ getState, request }) {
