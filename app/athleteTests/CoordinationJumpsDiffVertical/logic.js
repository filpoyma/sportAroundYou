...
export const getByDateRangeLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: COORDINATION_JUMPS_DIFF_VERTICAL_BY_DATE_RANGE_LOAD_SUCCESS,
    failType: COORDINATION_JUMPS_DIFF_VERTICAL_BY_DATE_RANGE_LOAD_ERROR
  },
...
export const getAllLogic = createLogic({
  ...
  processOptions: {
    dispatchReturn: true,
    successType: COORDINATION_JUMPS_DIFF_VERTICAL_LOAD_SUCCESS,
    failType: COORDINATION_JUMPS_DIFF_VERTICAL_LOAD_ERROR
  },
  process({ getState, request }) {
