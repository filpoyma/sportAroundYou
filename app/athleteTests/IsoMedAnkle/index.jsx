...
class IsoMedAnkleTest extends Component {
  state = {
...
IsoMedAnkleTest.defaultProps = {
  results: {}
};

IsoMedAnkleTest.displayName = 'IsoMedAnkleTest';

// IsoMedAnkleTest.whyDidYouRender = true;
